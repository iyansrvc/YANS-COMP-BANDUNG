...
#if defined(ARDUINO_ESP32S3) // Periksa jika board adalah ESP32-S3
#include <stdio.h>  // Gunakan stdio.h yang lebih umum untuk ESP32
#endif

// Penyesuaian pin SPI untuk YD-ESP32-S3-N16R8
#define BL_PIN   9  // Backlight (BLK)
#define CS_PIN   10  // Chip Select (CS)
#define DC_PIN   11  // Data/Command (DC)
#define RST_PIN  12  // Reset (RES)
#define SDA_PIN  13  // Data (SDA)
#define SCL_PIN  14  // Clock (SCL)

#define LCD_WIDTH   280 // LCD width
...
class st7789v3 {
    ...
    private:
        ...
        void Write_Command(uint8_t cmd);  // Deklarasi fungsi Write_Command
        void Write_Data(uint8_t data);   // Deklarasi fungsi Write_Data
