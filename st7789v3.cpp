...
******************************************************************************/
void st7789v3::Init(uint8_t cs, uint8_t dc, uint8_t rst, uint8_t bl){
    ...
    WriteReg(0x29);  // Enable display after initialization
}
...
*******************************************************************************/
void st7789v3::WriteReg(uint8_t data) {
...
void st7789v3::WriteData_Byte(uint8_t data) {
    digitalWrite(spi_cs, LOW);
...
void st7789v3::WriteData_Word(uint16_t data) {
...
*******************************************************************************/
void st7789v3::SetBacklight(uint16_t Value) {
    if(Value > 100)
        Value=100;
...
******************************************************************************/
void st7789v3::SetCursor(uint16_t Xstart, uint16_t Ystart, uint16_t Xend, uint16_t Yend) {
    // if (horizontal) {
    ...
    // else {
        ...
        WriteData_Byte(Xstart + 34);
        WriteData_Byte(Xend >> 8);
        WriteData_Byte(Xend + 34);
    // }
...
******************************************************************************/
void st7789v3::Clear(uint16_t Color) {
    uint16_t i,j;
    SetCursor(0, 0, LCD_WIDTH - 1, LCD_HEIGHT - 1);
...
parameter :
    ...
    color :   Set the color
******************************************************************************/
void st7789v3::ClearWindow(uint16_t Xstart, uint16_t Ystart, uint16_t Xend, uint16_t Yend, uint16_t color)
{
    uint16_t i,j;
    SetCursor(Xstart, Ystart - 1, Xend, Yend - 1);
...
parameter :
    ...
    Color :   Set the color
******************************************************************************/
void st7789v3::SetWindowColor(uint16_t Xstart, uint16_t Ystart, uint16_t Xend, uint16_t Yend, uint16_t Color) {
...
parameter :
    ...
    Color :   Set the color
******************************************************************************/
void st7789v3::SetUWORD(uint16_t x, uint16_t y, uint16_t Color) {
    SetCursor(x,y,x,y);
    WriteData_Word(Color);
} 
...
/******************************************************************************
  ...
  parameter:
    Rotate   :   0,90,180,270
******************************************************************************/
void st7789v3::SetRotate(uint16_t Rotate)
{
...
******************************************************************************/
void st7789v3::SetMirroring(uint8_t mirror)
{
...
******************************************************************************/
void st7789v3::SetPixel(uint16_t Xpoint, uint16_t Ypoint, uint16_t Color)
{
...
******************************************************************************/
void st7789v3::DrawPoint(uint16_t Xpoint, uint16_t Ypoint, uint16_t Color,
...
******************************************************************************/
void st7789v3::DrawLine(uint16_t Xstart, uint16_t Ystart, uint16_t Xend, uint16_t Yend, uint16_t Color, DOT_PIXEL Line_width, LINE_STYLE Line_Style)
{
...
******************************************************************************/
void st7789v3::DrawRectangle(uint16_t Xstart, uint16_t Ystart, uint16_t Xend, uint16_t Yend, uint16_t Color, DOT_PIXEL Line_width, DRAW_FILL Filled )
{
    // if (Xstart > LCD_WIDTH || Ystart > LCD_HEIGHT ||
    //     Xend > LCD_WIDTH || Yend > LCD_HEIGHT) {
...
******************************************************************************/
void st7789v3::DrawCircle(uint16_t X_Center, uint16_t Y_Center, uint16_t Radius, uint16_t Color, DOT_PIXEL Line_width, DRAW_FILL Draw_Fill)
{
...
******************************************************************************/
void st7789v3::DrawChar(int16_t Xpoint, int16_t Ypoint, const char Acsii_Char, sFONT* Font, int16_t Color_Background, int16_t Color_Foreground)
{
    int16_t Page, Column;
...
/******************************************************************************
  ...
  parameter:
    ...
    Color_Foreground : Select the foreground color of the English character
******************************************************************************/
void st7789v3::DrawString_EN(int16_t Xstart, int16_t Ystart, const char * pString, sFONT* Font, int16_t Color_Background, int16_t Color_Foreground)
{
...
******************************************************************************/
#define  ARRAY_LEN 50
void st7789v3::DrawNum(int16_t Xpoint, int16_t Ypoint, int32_t Nummber, sFONT* Font, int16_t Color_Background, int16_t Color_Foreground )
{
...
******************************************************************************/
void st7789v3::DrawFloatNum(int16_t Xpoint, int16_t Ypoint, double Nummber, int8_t Decimal_Point, sFONT* Font, int16_t Color_Background, int16_t Color_Foreground)
{
...
/******************************************************************************
  ...
  parameter:
    ...
    yEnd             : Image height
******************************************************************************/
void st7789v3::DrawImage(const unsigned char *image, int16_t xStart, int16_t yStart, int16_t W_Image, int16_t H_Image)
{
  int i, j;
  for (j = 0; j < H_Image; j++) {
    for (i = 0; i < W_Image; i++) {
